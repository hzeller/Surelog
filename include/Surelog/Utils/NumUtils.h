...
// but but be lenient in the interpretation.
// The full signed negative range and positive unsigned range for that integer
// size is allowed. The final value is cast to the signed or unsigned
